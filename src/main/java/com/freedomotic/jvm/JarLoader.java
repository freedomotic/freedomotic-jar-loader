 ...
 *
 *
 * Original code by Chris Jennings <https://cgjennings.ca/contact.html>
 */
public class JarLoader {
	...
	/**
	 * Adds a JAR file to the list of JAR files searched by the system classloader.
